...
train_texts, test_texts, train_labels, test_labels = train_test_split(all_phrases,all_intents,train_size=0.9,random_state=42)
train_texts, eval_texts, train_labels, eval_labels = train_test_split(train_texts,train_labels,test_size=0.11,random_state=42)
...
encodings_test = tokenizer(test_texts,padding = True,truncation = True,return_tensors = "pt", max_length = 32)
...
test_dataset = JarvisIntentDataset(encodings_test, test_labels)
